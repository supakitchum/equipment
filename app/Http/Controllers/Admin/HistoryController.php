    ...
    public function excel(Request $request)
    {
        ...
        foreach ($reservings as $reserving) {
            array_push($fetch_data, [
                ...
                "จำนวนวันที่ถูกยืม" => Carbon::parse($reserving->approve_date)->diffForHumans(),
                "วันสร้างครุภัณฑ์" => Carbon::parse($reserving->created_at)->addYear(543),
                "วันที่ร้องขอ" => Carbon::parse($reserving->request_date)->addYear(543),
                "วันที่อนุมัติการยืม" => Carbon::parse($reserving->approve_date)->addYear(543),
                "วันที่ปฎิเสธ" => Carbon::parse($reserving->reject_date)->addYear(543),
                "วันที่แลกเปลี่ยน" => Carbon::parse($reserving->transfer_date)->addYear(543),
                "วันที่คืน" => Carbon::parse($reserving->return_date)->addYear(543),
